...
define('SECOND_DRAWN_NUMBER', 'second:');
define('THIRD_DRAWN_NUMBER', 'third:');
define('FOURTH_DRAWN_NUMBER', 'fourth:');
...
define('CORRECT_THIRD_DRAWN_NUMBER', 'Correct third drawn number please');
define('CORRECT_FOURTH_DRAWN_NUMBER', 'Correct fourth drawn number please');
define('CORRECT_FIFTH_DRAWN_NUMBER', 'Correct fifth drawn number please');
define('CORRECT_SIXTH_DRAWN_NUMBER', 'Correct sixth drawn number please');

define('LUCKY_NUMBERS', 'Your unsort outcome:');
define('SORT_LUCKY_NUMBERS', 'Your outcomes:');
...
define('LOGOUT', 'You`ve Logged Out of Lotek');

define('CHECK_M', 'Check');
define('LOGOUT_M', 'Logout');
