	...
	<body id="number_i">
		...
		<div class="container-fluid">		
			<header id="hdr">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="imp">
									<ul class="nav navbar-nav">
										<li class="active" id="number-i"><a href="number_i.php"><?php echo $Languages->translator('CHECK_M'); ?></a></li>
				...
				<ol class="breadcrumb">
					<li class="active">
						<a href="number_i.php" class="breadcrumb" data-toggle="tooltip" data-placement="right" title="<?php echo $Languages->translator('CHECK_NUMBERS'); ?>"><span class="glyphicon glyphicon-check"></span><?php echo '&nbsp' . $Languages->translator('CHECK_M'); ?></a>
					</li>
				</ol>
			</header>
