	...
	<body id="privacy_i">
		...
		<div class="container-fluid">				
			<header id="hdr">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="imp">
									<ul class="nav navbar-nav">
										...
										{ ?>
										<li class="active" id="privacy-i"><a href="privacy_i.php"><?php echo $Languages->translator('MY_ACCOUNT_M'); ?></a></li>	
				...
				<ol class="breadcrumb">
					<li class="active">
						<a href="privacy_i.php" class="breadcrumb"><span class="glyphicon glyphicon-user"></span> <?php echo $Languages->translator('MY_ACCOUNT_M'); ?></a>
					</li>
				</ol>
			</header>
