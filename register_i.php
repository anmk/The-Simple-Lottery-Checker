	...
	<body id="register_i">
		...
		<div class="container-fluid">
			<header id="hdr">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="imp">
									<ul class="nav navbar-nav">
										...
										<li class="active" id="register-i"><a href="register_i.php"><?php echo $Languages->translator('REGISTER_M'); ?></a></li>
										<?php } ?>
									</ul>
								</div>
							</div>
				...
				<ol class="breadcrumb">
					<li class="active">
						<a href="register_i.php" class="breadcrumb"><span class="glyphicon glyphicon-registration-mark"></span><?php echo '&nbsp' . $Languages->translator('REGISTER_M'); ?></a>
					</li>
				</ol>
			</header>
			...
			<section class="row">
				...
				<div class="col-lg-6 col-md-8 col-sm-10 col-xs-12 tCnt">
					<?php include_once(APP_PATH.FILE_REGISTER); ?>
				</div>
