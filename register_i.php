	...
	<body id="register_i">
		<div class="container-fluid">	
			...
			<header id="hdr">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="imp">
									<ul class="nav navbar-nav">
										...
										<li class="active" id="register-i"><a href="register_i.php"><?php echo REGISTER_M; ?></a></li>
										<?php } ?>
									</ul>
								</div>
							</div>
				...
				<ol class="breadcrumb">
					<li class="active"><a href="register_i.php" class="breadcrumb"><span class="glyphicon glyphicon-registration-mark"></span><?php echo '&nbsp' . REGISTER; ?></a></li>
				</ol>
			</header>
