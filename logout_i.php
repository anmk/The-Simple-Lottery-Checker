	...
	<body id="logout_i">
		<div class="container-fluid">		
			...
			<header id="hdr">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="imp">
									<ul class="nav navbar-nav">
										...
										<li class="active" id="logout-i"><a href="logout_i.php"><?php echo LOGOUT_M; ?></a></li>
										<?php } else { ?>
				...
				<ol class="breadcrumb">
					<li class="active"><a href="logout_i.php" class="breadcrumb">><span class="glyphicon glyphicon-log-out"></span> <?php echo CHECK; ?></a></li>
				</ol>
			</header>
